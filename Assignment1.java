...
public class Assignment1 extends JPanel {
        ...
        private void drawBezierCurveMine(Graphics g, int x1, int y1, int ctrlX, int ctrlY, int x2, int y2,
                        int thickness,
                        Color color) {
                int resolution = 500;
                g.setColor(color);
        ...
        private void drawnSky(Graphics g, int x, int y) {
                ...
                for (int i = 0; i <= count; i++) {
                        ...
                        drawBezierCurveMine(g, -50, currentY, 200, currentY - 50, 400, currentY + 50, 650, currentY,
                                        (int) step * 3,
                                        colorCurrent);
                }
        }
        ...
        private void drawnStar(Graphics g, int width, int height, int maxsize) {
                int count = 200;
                for (int i = 0; i < count; i++) {
                        fillRectWithRound(g, getRandomNumber(0, width), getRandomNumber(0, height),
                                        getRandomNumber(1, maxsize),
                                        Color.WHITE);
                }
        }
        ...
        private void drawNoteBook(Graphics g, int x, int y) {
                ...
                BufferedImage buffer = new BufferedImage(601, 601, BufferedImage.TYPE_INT_ARGB);
                Graphics2D g2 = buffer.createGraphics();
                drawSquare(g2, x + 10, y + 50, x + 56, y + 40, x + 80, y + 55, x + 40, y + 70, null,
                                Color.decode("#40476E"),
                                1);
                // keyboard
        ...
        private void drawFireworks(Graphics g, int x, int y, int size) {
                ...
                for (int i = 1; i <= count; i++) {
                        ...
                        drawDottedQuadraticBezierCurveMine(g, centerX, centerY, (centerX + (stepP * i) / 2),
                                        (y + (stepP * i) / 2),
                                        (centerX + points[0]),
        ...
        private void drawHuman(Graphics g, int x, int y, int size) {
                ...
                // L
                drawBezierCurveMine(g2, startAL1[0], startAL1[1], x + 16, y + 27, x + 25, y + 39, x + 14, y + 11,
                                thickness,
                                colorLine);
                ...
                // R
                drawBezierCurveMine(g2, startAR1[0], startAR1[1], x + 108, y + 35, x + 103, y + 40, x + 113, y + 13,
                                thickness,
                                colorLine);
                drawBezierCurveMine(g2, startAR2[0], startAR2[1], x + 105, y + 58, x + 108, y + 53, x + 126, y + 19,
                                thickness,
                                colorLine);
                drawLine(g2, x + 113, y + 13, x + 126, y + 19, Color.BLACK, thickness);
                // hand
                // L
                drawBezierCurveMine(g2, x + 5, y + 13, x - 2, y + 5, x + 10, y + 1, x + 14, y + 3, thickness,
                                colorLine);
                drawBezierCurveMine(g2, x + 14, y + 3, x + 18, y - 10, x + 18, y + 8, x + 13, y + 12, thickness,
                                colorLine);
                // R
                drawBezierCurveMine(g2, x + 122, y + 16, x + 130, y + 5, x + 124, y + 1, x + 114, y + 4, thickness,
                                colorLine);
                drawBezierCurveMine(g2, x + 114, y + 4, x + 110, y - 10, x + 110, y + 8, x + 114, y + 13, thickness,
                                colorLine);
                // shirt
                int endSL[] = { x + 37, y + 109 };
                int endSR[] = { x + 89, y + 108 };
                // L
                drawBezierCurveMine(g2, endNL[0], endNL[1], x + 41, y + 38, x + 41, y + 38, startAL1[0], startAL1[1],
                                thickness,
                                colorLine);
                drawBezierCurveMine(g2, startAL2[0], startAL2[1], x + 16, y + 115, x + 16, y + 95, endSL[0], endSL[1],
                                ...
                                colorLine);
                // R
                drawBezierCurveMine(g2, endNR[0], endNR[1], x + 83, y + 36, x + 79, y + 39, startAR1[0], startAR1[1],
                                thickness,
                                colorLine);
                drawBezierCurveMine(g2, startAR2[0], startAR2[1], x + 104, y + 114, x + 114, y + 104, endSR[0],
                                endSR[1],
                                thickness,
                                colorLine);
                // trousers
                ...
                // L
                drawBezierCurveMine(g2, endSL[0], endSL[1], x + 34, y + 200, endTL1[0], endTL1[1], thickness,
                                colorLine);
                drawBezierCurveMine(g2, center[0], center[1], x + 53, y + 200, x + 53, y + 194, endTL2[0], endTL2[1],
                                thickness,
                                colorLine);
                // R
                drawBezierCurveMine(g2, endSR[0], endSR[1], x + 103, y + 219, x + 103, y + 208, endTR1[0], endTR1[1],
                                thickness,
                                colorLine);
                drawBezierCurveMine(g2, center[0], center[1], x + 74, y + 162, x + 71, y + 149, endTR2[0], endTR2[1],
                                thickness,
                                colorLine);
                // foot
                // L
                drawBezierCurveMine(g2, endTL1[0], endTL1[1], x + 27, y + 207, x + 40, y + 217, x + 34, y + 222,
                                thickness,
                                colorLine);
                drawBezierCurveMine(g2, x + 34, y + 222, x + 26, y + 230, x + 53, y + 230, x + 45, y + 220, thickness,
                                colorLine);
                drawBezierCurveMine(g2, x + 45, y + 220, x + 45, y + 210, x + 55, y + 205, endTL2[0], endTL2[1],
                                thickness,
                                colorLine);
                // R
                drawBezierCurveMine(g2, endTR1[0], endTR1[1], x + 100, y + 214, x + 98, y + 219, x + 100, y + 222,
                                thickness,
                                colorLine);
                drawBezierCurveMine(g2, x + 100, y + 222, x + 103, y + 226, x + 83, y + 229, x + 88, y + 221, thickness,
                                colorLine);
                drawBezierCurveMine(g2, x + 88, y + 221, x + 90, y + 210, x + 79, y + 210, endTR2[0], endTR2[1],
                                thickness,
                                colorLine);
